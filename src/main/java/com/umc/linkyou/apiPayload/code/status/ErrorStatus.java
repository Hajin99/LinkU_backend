...
public enum ErrorStatus implements BaseErrorCode {
    ...
    _USER_INACTIVE(HttpStatus.FORBIDDEN, "USERS4032", "사용자가 INACTIVE 임시 회원탈퇴 상태입니다."),
    _USER_PROFILE_INCOMPLETE(HttpStatus.FORBIDDEN, "USERS4033","프로필 설정이 완료되지 않은 계정입니다"),
